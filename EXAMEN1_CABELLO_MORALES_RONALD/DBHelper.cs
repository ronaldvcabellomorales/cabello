...
namespace EXAMEN1_CABELLO_MORALES_RONALD.Classes
{
    public class DBHelper
    {
        ...
        public static SqlParameter MakeParamFec(string paramName, SqlDbType dbType, int size, object objValue)
              //                                    ("@fecafp", SqlDbType.Date            , 0 , personal.Fecafp)  
        {
            SqlParameter param;
            ...
            if ( Convert.ToDateTime( objValue) <= DateTime.ParseExact("01/01/1753", "dd/mm/yyyy", null))
            {
                param.Value = null;
            }
            else
