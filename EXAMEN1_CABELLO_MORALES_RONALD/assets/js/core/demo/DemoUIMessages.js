(function (namespace, $) {
	...
	p._initActionToastr = function () {
		...
		$('#toast-long-action').on('click', function (e) {
			...
			var message = 'La conexión se agotó debido a la configuración del firewall. Mostrando limitado. <button type="button" id="okBtn" class="btn btn-flat btn-warning toastr-action">Retry</button>';
			toastr.info(message, '');
		});
	};
